...
#### Что такое XT-IDE?
[XT-IDE](https://github.com/glitchwrks/xt_ide) – это плата расширения для шины ISA, разработанная энтузиастами ретрокомпьютинга для подключения современных IDE-устройств к древним ПК. Название отсылает к IBM PC XT (1983) – компьютеру, на котором впервые появилась шина ISA, но который ещё не имел стандарта IDE.
